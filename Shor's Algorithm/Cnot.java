...
public class Cnot { 
    ...
    */   
    public static void main(String[] args) throws IOException{ 		
		...
		// note here I'm choosing to simulate Shor's algorithm, though you can also chooseGrover. 
		chooseShorsExplicitFunctionGate();
	...
	**/
	static void chooseShorsExplicitFunctionGate()
	{
		...
		System.out.println("Select number to factorise:");
		int noToFactorise = sc.nextInt();
